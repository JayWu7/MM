...
UNDERLYING_TOKEN = "BTC"        # Base token for trading
QUOTE_TOKEN = "USDT"            # Quote currency used for pricing
...
MM_LIVE_ORDER_NUMS = 30          # Number of live MM orders
MM_MIN_ORDER_SIZE = 0.0001        # Minimum size for MM orders
MM_MAX_ORDER_SIZE = 0.1          # Maximum size for MM orders
...
HG_MIN_HEDGE_ORDER_SIZE = 0.001        # Minimum hedge order size
